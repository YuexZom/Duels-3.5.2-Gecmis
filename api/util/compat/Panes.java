...
public final class Panes {
    private static final Map<Short, String> DATA_TO_PANE = new HashMap<Short, String>();

    public static Material from(short data) {
        return Material.getMaterial((String)DATA_TO_PANE.get(data));
    }
